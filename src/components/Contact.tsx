        ...
        <div className="max-w-3xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="name" className="block text-slate-lightest mb-2">
                  Your Name
                </label>
                <Input
                  id="name"
              ...
              <div>
                <label htmlFor="email" className="block text-slate-lightest mb-2">
                  Your Email
                </label>
                <Input
                  id="email"
            ...
            <div>
              <label htmlFor="subject" className="block text-slate-lightest mb-2">
                Subject
              </label>
              <Input
                id="subject"
            ...
            <div>
              <label htmlFor="message" className="block text-slate-lightest mb-2">
                Your Message
              </label>
              <Textarea
                id="message"
