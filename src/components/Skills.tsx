...
const SkillItem = ({ name, proficiency }: SkillItemProps) => (
  <div className="mb-4">
    ...
    <div className="skill-bar">
      <div className="skill-progress" style={{ width: `${proficiency}%` }}></div>
    </div>
  </div>
);
    ...
    <section id="skills" className="bg-navy-light">
      <div className="section-container">
        <div className="text-center mb-12">
          ...
          <h2 className="heading text-2xl md:text-4xl">Technologies I Work With</h2>
        </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-slate max-w-2xl mx-auto">
            I'm constantly learning and adding new skills to my repertoire. I believe in staying current with 
