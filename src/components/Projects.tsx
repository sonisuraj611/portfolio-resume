...
const projects = [
  {
    title: 'SocialPad App',
    description: 'Built a MERN app where users can connect with their friends and share thoughts and photos with them. Features include logging with JWT authentication, storing data in mongoDB, MVC pattern, light-dark mode, react-dropzone for uploading photos.',
  ...
  {
    title: 'Youtube Clone',
    description: 'Developed a YouTube clone website that fetches data from RapidAPI. Search and watch any video directly within website.',
  ...
  },
  {
    ...
    description: 'Built multiple RESTful APIs including features like register and login(JWT, bcrypt), CRUD operations with MongoDB, Middleware integration for logging, validation, etc.',
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="md:w-2/5 z-10">
                <h3 className="subheading mb-2">{index % 2 === 0 ? 'Featured Project' : 'Recent Work'}</h3>
                <h4 className="text-xl md:text-2xl font-semibold text-white mb-4">{project.title}</h4>
